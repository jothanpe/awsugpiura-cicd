 ...
 *
 * NOTA: self-mutation desactivado. El pipeline se despliega una vez a mano
 * (`npm run deploy`) y a partir de ahí solo cambia el código de `app/`. La etapa
 * de Assets publica los assets nuevos en cada corrida igual. Si cambias la
 * DEFINICIÓN del pipeline, vuelve a `npm run deploy`.
 */
